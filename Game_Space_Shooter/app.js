...
class EnemyUnit {
    ...
    spawn() {
        for (let i = 0; i < this.enemies.length; i++) {
            for (let w = 0; w < this.weapones.length; w++) {
...
class Ship extends Phaser.Sprite {
    ...
    addWeapon(_weapon, _relativePosition = null) {
...
class MovementPatterns {
    constructor() {
        ...
        let point0 = new Vector2(500, 500);
